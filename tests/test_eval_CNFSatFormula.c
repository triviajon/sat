...
void test_eval_CNFSatFormula() {
     ...
     *  partition on formula (satisifiability): formula is satisfiable, formula is not satisfiable
     */


    {    
        printf("  Test (covers result is true, +AND, -OR, -NOT, #clauses = 2, formula is satisfiable):\n");
    ...
    {
        printf("  Test (covers result is true, -AND, +OR, -NOT, #clauses = 1, formula is satisfiable):\n");
        char *cnf_string1 = "(x|y)";
        CNFSatFormula *cnf_sat1 = parse_CNF(cnf_string1);
        UniqueVarArray *uniqueVars1 = find_unique_variables(cnf_sat1);
        VarMap *var_map1 = init_VarMap();
    ...
    {
        printf("  Test (covers result is false, -AND, -OR, +NOT, #clauses = 1, formula is satisfiable):\n");
    ...
    {
        printf("  Test (covers result is false, +AND, +OR, +NOT, #clauses > 2, formula is not satisfiable):\n");
